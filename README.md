...
Fuzzzy Seal is your personal, **offline encryption system**. It gives you private, local "message spaces" for two parties. Perfect for managing encrypted words and files you plan to share.
...
Ready to start fuzzing? Fuzzzy Seal runs on **Android, Windows, macOS and Linux**. (The web build is
...
- **Android:** [Download Fuzzzy Seal vX.Y.Z APK](https://github.com/fuzzzer/fuzzy_chat/releases/tag/v1.0.0)
- **Windows (64-bit):** [Download Fuzzzy Seal vX.Y.Z ZIP](https://github.com/fuzzzer/fuzzy_chat/releases/tag/v1.0.0)
- **macOS (Universal):** [Download Fuzzzy Seal vX.Y.Z DMG](https://github.com/fuzzzer/fuzzy_chat/releases/tag/v1.0.0)
- **Linux (AppImage) (TO BE ADDED SOON):** [Download Fuzzzy Seal vX.Y.Z AppImage](https://github.com/fuzzzer/fuzzy_chat/releases/tag/v1.0.0)
...
- You pop it into a Connected Fuzzzy Seal Text Field
- _POOF!_ Fuzzzy Seal scrambles it into a jumble of nonsense letters and numbers.
...
- Only the person with the matching Fuzzzy Seal "key" can turn that jumble back into your precious secret.

That's Fuzzzy Seal! It wraps your digital secrets in a cozy, unreadable blanket, ensuring only your chosen partner can peek inside.

## Why Fuzzzy Seal? Unleash Your Inner Secret Agent (or just be sensible)!

Fuzzzy Seal is for anyone who values true privacy, whether you're:
...
- ✈️ **Going Off-Grid (or just having spotty Wi-Fi):**
  ...
  - Working on a project in a secure facility with no internet access (an "air-gapped" setup)? Fuzzzy Seal doesn't mind.
...
Basically, if it's important and needs to stay between just you and one other person, Fuzzzy Seal is your friend.
...
1.  **You (The Mastermind):**
    ...
    - Open Fuzzzy Seal and tap `+ New Chat`.
...
2.  **Your TRUSTED ALLY:**
    ...
    - Opens Fuzzzy Seal on their device and taps `Accept Invitation`.
    - They'll paste the `Invitation Code` you sent and can give the channel their own codename. Tap `Accept Invitation`.
    - Fuzzzy Seal will then generate an **Acceptance Code**. They need to `Copy Acceptance`.
...
1.  **Open the Channel:** Tap on its codename (e.g., "Operation Rubber Ducky") in your Fuzzzy Seal list.
...
3.  **Hit the "Scramble" Button (aka Send):** Tap the **send icon** (paper plane ▶️).
    - Fuzzzy Seal instantly encrypts it into gobbledygook.
...
5.  **YOUR ALLY Unscrambles:**
    - They open the same channel in their Fuzzzy Seal.
...
- **Fuzzy is Your Friend (Plain Text is Not!):** The only thing that can "expose" you is sharing something that _isn't_ fuzzed!
  - The scrambled "fuzz" (encrypted content) from Fuzzzy Seal? Totally safe to splash all over the internet. It's designed to be unreadable nonsense to anyone but your linked secret sharer.
  - Plain text messages or unencrypted files you _meant_ to fuzz but forgot? Well, that's like shouting your secret password in a crowded library. Fuzzzy Seal can't help you if you don't use it first! So, always fuzz before you fuss (with sending).
...
Happy (and secure) scheming with Fuzzzy Seal! 🛡️
