...
import 'fuzzzy_seal_localizations.dart';

// ignore_for_file: type=lint

/// The translations for English (`en`).
class FuzzzySealLocalizationsEn extends FuzzzySealLocalizations {
  FuzzzySealLocalizationsEn([String locale = 'en']) : super(locale);
