...
class FuzzyChatLocalizationsKa extends FuzzyChatLocalizations {
  ...
  String get aboutEncryptionBodyHistory =>
      'ყველა შეტყობინება, რომელსაც აგზავნით ან გაშიფრავთ, აპლიკაციაში ინახება — თითოეული ჩატისთვის ცალკე გასაღებით დალუქული, რომელიც მხოლოდ ამ მოწყობილობას აქვს. თუ აპლიკაციის ჩაკეტვის პაროლი გაქვთ დაყენებული, ეს გასაღები მით არის დაცული — პაროლის გარეშე შენახული ისტორია ვერ გაიხსნება. განბლოკვის შემდეგ ჩატები ღია რჩება, სანამ აპლიკაციას არ დახურავთ; აპლიკაცია დროის გასვლის შემდეგ თავისით არ იკეტება. თუ ბიომეტრიულ განბლოკვას ჩართავთ, თქვენი პაროლი ამ მოწყობილობაზე უსაფრთხოდ ინახება, რათა თითის ანაბეჭდით ან სახით გაიხსნას.';
  ...
  String get aboutEncryptionBodyErrors =>
      '„უკვე გაშიფრულია“: ეს შეტყობინება ამ მოწყობილობაზე უკვე გაიშიფრა და მეორედ ვეღარ წაიკითხება. „ეს არ არის სწორი დაშიფრული შეტყობინება“: ტექსტი დაზიანებულია, არასრულია ან სხვა ჩატს ეკუთვნის — აპლიკაცია ამათ ერთმანეთისგან ვერ არჩევს. „ძალიან ძველია“: მასზე ბევრად ახალი შეტყობინებები უკვე გაიშიფრა. „არასწორი პაროლი“ (მარტივი დაშიფრვა): პაროლი არ ემთხვევა, ან ტექსტი თუ ფაილი დაზიანებულია — აპლიკაცია ამასაც ვერ არჩევს. ფაილების შემთხვევაში, თუ მიღება დაწყების შემდეგ ჩაიშალა ან გაუქმდა, ფაილის ერთჯერადი გასაღები უკვე გამოყენებულია: სთხოვეთ გამომგზავნს, ხელახლა გამოგზავნოს.';
  ...
  String get aboutEncryptionBodyUnderTheHood =>
      'შეტყობინებები Olm-ის ორმაგ რაჩეტს (double ratchet) იყენებს (vodozemac, დამოუკიდებლად აუდიტირებული) — ყოველ შეტყობინებას ახალი გასაღები აქვს, სწორედ ამიტომ არის დაშიფრული ტექსტი ერთჯერადი. ფაილები XChaCha20-Poly1305-ით ნაწილ-ნაწილ ილუქება და, თუ რომელიმე ნაწილი დაზიანებულია, ფაილი უარყოფილი იქნება, სანამ დისკზე რამე ჩაიწერება. პაროლები Argon2id-ით მუშავდება. ყველა გასაღები აპლიკაციის ნატიურ ბირთვშია და ამ მოწყობილობას არასდროს ტოვებს. ვებ-ვერსია არ არსებობს: ბირთვი ნატიური კოდია.';
