...
const _missingPath =
    '/storage/emulated/0/Download/Fuzzy Chat/Fz bot/secret.jpg.fuzz';
...
class _MissingFile extends Fake implements File {
  ...
  @override
  Directory get parent => Directory('/storage/emulated/0/Download/Fuzzy Chat');
}
  ...
  group('file bubble (T-0366)', () {
    testWidgets(
      ...
      await _withMissingFiles(() async {
        ...
        expect(find.text('Downloads › Fuzzy Chat › Fz bot'), findsOneWidget);
